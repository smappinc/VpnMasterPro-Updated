...
public class PrefManager {
    ...
    public static final String KEYTIME = "0";
    public static final String Boo = "0";
    ...
    public static boolean isFirst(Context context){
        final SharedPreferences reader = context.getSharedPreferences(KEY_NOT_FIRST_OPEN, Context.MODE_PRIVATE);
