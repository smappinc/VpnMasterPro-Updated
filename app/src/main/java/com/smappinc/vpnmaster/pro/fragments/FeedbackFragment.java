...
import com.smappinc.vpnmaster.pro.Util.FragActivity;
...
public class FeedbackFragment extends Fragment {
	...
	public static final String marketURI = "market://details?id=pp.BudingoVPN";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	b.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				i.putExtra(Intent.EXTRA_EMAIL, new String[] {"cernekee+oc@gmail.com"});
				i.putExtra(Intent.EXTRA_SUBJECT, "ics-openconnect v" +
