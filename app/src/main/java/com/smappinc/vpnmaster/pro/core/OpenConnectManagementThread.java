...
import com.smappinc.vpnmaster.pro.Util.AuthFormHandler;
...
public class OpenConnectManagementThread implements Runnable, OpenVPNManagement {
   ...
   public static String iptoConnect="";
...
//			}
	...
	private void errorAlert(String message) {
		mOpenVPNService.promptUser(new ErrorDialog(mOpenVPNService,mContext,mPrefs,
