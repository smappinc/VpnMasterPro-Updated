...
public class VpnProfileControlActivity extends AppCompatActivity
{
	...
	String Best_server    ,  USER_NAME,PASSWORD,REMOTE_ID,strong_swan_alias;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		Best_server= getIntent().getStringExtra("Connection_Ip");
...
//		dataSource.open();
//		VpnProfile profile = dataSource.getVpnProfile("");
//		dataSource.close();
//
//		startVpnProfile(profile);
		...
		profile.setGateway(Best_server);
