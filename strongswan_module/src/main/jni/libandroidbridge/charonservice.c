 ...
 */
JNI_METHOD_P(org.strongswan.android_utils, Utils, isProposalValid, jboolean,
 ...
 */
JNI_METHOD_P(org.strongswan.android_utils, Utils, parseInetAddressBytes, jbyteArray,
	jstring address)
{
	jbyteArray bytes;
	host_t *host;
